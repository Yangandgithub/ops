...
class ElfinderConnector:
    ...
    def execute(self, cmd, **kwargs):
        ...
        print('arguments coming into workers', kwargs)
        # A little tricky with Python's functional programming feature.
    ...
    def _open(self, target='', init=False, tree=False):
        ...
        **Command**: Open a directory
        ...
        method must be used.
        """
        print('accept some key parameters', target, init, tree)
